...
(cl:ensure-generic-function 'heigh-val :lambda-list '(m))
(cl:defmethod heigh-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_pub_sub-msg:heigh-val is deprecated.  Use plumbing_pub_sub-msg:heigh instead.")
  (heigh m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Person>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'heigh))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Person>) istream)
  "Deserializes a message object of type '<Person>"
    ...
    (cl:setf (cl:slot-value msg 'heigh) (roslisp-utils:decode-single-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Person>)))
  ...
  "8d6863bac8f832699af5053b666b7f25")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Person)))
  "Returns md5sum for a message object of type 'Person"
  "8d6863bac8f832699af5053b666b7f25")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person>)))
  ...
  (cl:format cl:nil "string name~%int32 age~%float32 heigh~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person)))
  "Returns full string definition for message of type 'Person"
  (cl:format cl:nil "string name~%int32 age~%float32 heigh~%~%~%"))
